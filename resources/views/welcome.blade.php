             ...
             <div class="row section_text stext">
                ...
                <div id="section_img" class="row text-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <img class="img-responsive link_img-main" src="{{asset('/img/lending-minsk.png')}}" alt="lending-minsk">
                    </div>

                    <div class="col-md-4">
                        <h1 class="item_h1">Настройка контекстной рекламы</h1>
                        <img class="img-responsive link_img-main" src="{{asset('/img/page.png')}}" alt="page">
                    </div>

                    <div class="col-md-4">
                        <h1 class="item_h1">Визуальный редактор содержимого</h1>
                        <img  class="img-responsive link_img-main" src="{{asset('/img/lending.png')}}" alt="lending">
                    </div>
                    
                      <div class="col-md-4">
                        <br><h1 class="item_h1">Экономия Ваших денег и времени</h1>
                        <img class="img-responsive link_img-main" src="{{asset('/img/landing-minsk.png')}}" alt="landing-minsk">
                    </div>
                    
                      <div class="col-md-4">
                        <br><h1 class="item_h1">2 недели технической поддержки</h1>
                        <img class="img-responsive link_img-main" src="{{asset('/img/odnostranichnyj-sajt.png')}}" alt="odnostranichnyj-sajt">
                    </div>
                    
                      <div class="col-md-4">
                        <br><h1 class="item_h1">Подключение <br> SSL-сертификата</h1>
                        <img class="img-responsive link_img-main" src="{{asset('/img/minsk.png')}}" alt="minsk">
                    </div>
